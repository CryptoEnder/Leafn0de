...
// Copyright (c) 2017 The BHN Core developers
 ...
 * BHN Core system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string FundAddress() const {return strFundAddress; }
