...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BHN Core bhncore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bhncore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BHN Core transaction") + "\n" +
                               "  bhncore-tx [options] -create [commands]   " + _("Create hex-encoded BHN Core transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BHN Core transaction
