                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LFN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LFN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and leafn0de: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LFN Core"), this);
    aboutAction->setStatusTip(tr("Show information about LFN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LFN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LFN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LFN addresses"));
    ...
    openAction->setStatusTip(tr("Open a leafn0de: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LFN Core help message to get a list with possible LFN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LFN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LFN Core network", "", count));
}
...
{
    QString strTitle = tr("LFN Core"); // default title
