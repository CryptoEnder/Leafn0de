                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BHN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BHN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bhncore: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BHN Core"), this);
    aboutAction->setStatusTip(tr("Show information about BHN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BHN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BHN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BHN addresses"));
    ...
    openAction->setStatusTip(tr("Open a bhncore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BHN Core help message to get a list with possible BHN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BHN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BHN Core network", "", count));
}
...
{
    QString strTitle = tr("BHN Core"); // default title
