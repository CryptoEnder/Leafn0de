...
/** Utility functions used by the BhnCore Qt UI.
 */
namespace GUIUtil
{
...
// Render BHN addresses in monospace font
...
// Parse "bhncore:" URI into recipient object, return true on successful parsing
