...
/** Utility functions used by the Leafn0de Qt UI.
 */
namespace GUIUtil
{
...
// Render LFN addresses in monospace font
...
// Parse "leafn0de:" URI into recipient object, return true on successful parsing
