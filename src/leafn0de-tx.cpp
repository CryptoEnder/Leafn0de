...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LFN Core leafn0de-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  leafn0de-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded LFN Core transaction") + "\n" +
                               "  leafn0de-tx [options] -create [commands]   " + _("Create hex-encoded LFN Core transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded LFN Core transaction
