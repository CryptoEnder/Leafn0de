...
RESOURCES += src/qt/leafn0de.qrc src/qt/leafn0de_locale.qrc

TRANSLATIONS += src/qt/locale/leafn0de_bg.ts \
                src/qt/locale/leafn0de_de.ts \
                src/qt/locale/leafn0de_en.ts \
                src/qt/locale/leafn0de_es.ts \
                src/qt/locale/leafn0de_fi.ts \
                src/qt/locale/leafn0de_fr.ts \
                src/qt/locale/leafn0de_it.ts \
                src/qt/locale/leafn0de_ja.ts \
                src/qt/locale/leafn0de_pl.ts \
                src/qt/locale/leafn0de_pt.ts \
                src/qt/locale/leafn0de_ru.ts \
                src/qt/locale/leafn0de_sk.ts \
                src/qt/locale/leafn0de_sv.ts \
                src/qt/locale/leafn0de_vi.ts \
                src/qt/locale/leafn0de_zh_CN.ts \
                src/qt/locale/leafn0de_zh_TW.ts
