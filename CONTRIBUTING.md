Contributing to LFN Core
==================================

The LFN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LFN Core project, and is not to be
confused with overall LFN Core Network Protocol consensus changes.

Whether a pull request is merged into LFN Core rests with the project merge
...
Patches that change LFN Core consensus rules are considerably more involved than
...
Where a patch set proposes to change the LFN Core consensus, it must have been
...
The project leader is the release manager for each LFN Core release.
