...
Intro
-----
LFN Core (LFN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. LFN Core utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run leafn0de-qt.exe.

LFN Core is the original LFN Core client and it builds the backbone of the network.
However, it downloads and stores the entire history of LFN Core transactions;
