...
In order to support loading of multiple wallets in leafn0de-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is leafn0de.cpp.
...
Changes to leafn0de.cpp
----------------------
leafn0de.cpp is the entry point into leafn0de-qt, and as such, will require some minor modifications to provide hooks for
