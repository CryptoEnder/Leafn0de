...
#   c) node1 mines 32 blocks, so now node 0 has 500000LFN, node 1 has 4250LFN, node2 has none.
#   d) node0 sends 601 LFN to node2, in two transactions (301 LFN, then 300 LFN).
